...
void inputData(datakaroke data[]), outputData(datakaroke data[]);
...
void mergeData(datakaroke data[], string file);
...
void menuUtama (){
	...
	system("cls");
	cout << "==============================================" << endl;
    cout << "||        Tugas Project Algo Lanjut         ||" << endl;
    cout << "|| NIM : 123220052                          ||" << endl;
    cout << "|| NIM : 123220043                          ||" << endl;
    cout << "|| NIM : 123220048                          ||" << endl;
    cout << "==============================================" << endl;
...
while(lagi) {
	...
	cout << "\nMasukkan nama file untuk menyimpan data yang telah diurutkan: ";
    string namaFile;
    cin >> namaFile;
    ofstream ofs1(namaFile);
    if (ofs1.is_open())
    {
        for (int i = 0; i < banyakData; i++)
        {
    ...
    cout << "Data berhasil disimpan di file " << namaFile << endl;
    cout << endl;
...
{	
    ...
    /* Cara kerjanya dengan menyisipkan elemen ke posisi yang tepat dari array yang sudah diurutkan 
     * atau menyisipkan / memasukkan setiap elemen secara berulang ulang ke dalam posisi yang benar.
     * pertama tama bandingkan posisi kedua dengan posisi disebalah kiri atau sebelumnya yaitu satu.
     * bandingkan apakah arrray sebelah kanan lebih besar dari sebelah kiri, jika ya posisi array dua tetap,
     * jika tidak pindah array sebelah kiri kekanan. dan seterusnya.
	*/ 
    else if (jawab == 2)
    {
        for (int i = 1; i < banyakData; i++)
...
void shellSort(datakaroke data[], string file)
{
    ...
    /* Cara kerja metode ini dengan  membandingkan suatu data dengan data lain yang memiliki jarak tertentu, kemudian dilakukan penukaran bila diperlukan 
     * Tentukan jarak data mula-mula, biasanya n/2, dimana n adalah jumlah data
     * Bandingkan x[1] dengan x[1+jarak], jika x[1]>x[1+jarak] tukar posisi, jika tidak tetap.
     * Lanjutkan perbandingan berikutnya untuk x[2] s/d X[(jarak)].
     * Tentukan jarak berikutnya : (n/2)/2, kemudian bandingkan lagi.
     * hingga jaraknya = 1
     */
...
void mergeData(datakaroke data[], string file)
{
    ...
    char pilih;
    cout << "Jawab 'y' untuk merge lagi atau 'n' untuk kembali kemenu utama : "; cin >> pilih;
    if (jawab == 'y' || jawab == 'Y') {
		lagi = true; }
	else {
		lagi = false; }
...
void updatingData(datakaroke data[], string file)
{
    ...
    cout << "Masukkan Nama yang datanya ingin di ubah\t: ";
    string nama;
    cin >> nama;
    cin.ignore();
    bool update = false;
    ...
    char pilih;
    cout << "Jawab 'y' untuk update lagi atau 'n' untuk kembali kemenu utama : "; cin >> pilih;
    if (jawab == 'y' || jawab == 'Y') {
		lagi = true; }
	else {
		lagi = false; }
...
void splitData(datakaroke data[], string file)
{
    ...
    banyakData += i - 1; // a += b; operator += digunakan untuk menambahkan nilai variabel b ke variabel a dan hasilnya disimpan kembali di variabel a.
    cout << setfill('-') << setw(122) << "-" << endl;
    cout << left << "|" << setfill(' ') << setw(16) << " Nama"
         << "|" << setfill(' ') << setw(23);
    cout << " Tipe Ruang"
