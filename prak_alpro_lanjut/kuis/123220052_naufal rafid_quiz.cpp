...
void cari_kamar(){
	...
	if (ketemu) {
		...
		cout << "Total harga : " << pesan[tmp].total_harga << endl;
		cout << "===================================" << endl << endl;}
	else {
 ...
 void sort_kamar(){
	 ...
	 if (jawab == 'a') {
		...
		for (i=0; i<n; i++) {
			cout << "===================================" << endl << endl;
		cout << "Nama : " << pesan[i].nama << endl;
		cout << "No. Kamar : " << pesan[i].no_kamar << endl;
		cout << "Jam masuk kamar : "<< pesan[i].jam_masuk << endl;
		cout << "Banyak hari menginap : " <<  pesan[i].banyak_hari << endl;
		cout << "Total harga : " << pesan[i].total_harga << endl;
		cout << "===================================" << endl << endl; }
