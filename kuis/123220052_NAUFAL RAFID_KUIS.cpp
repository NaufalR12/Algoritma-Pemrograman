...
if ( username == "naufal" && password == "123220052") {
	cout << "======================================" << endl;
	...
	if (nomenu >= 1 && nomenu <= 10 ) {
		...
		if ( total_harga_menu >= 125000 ){
			...
			if (diskon > 21000) { 
				diskon = 21000; }
			if ( total_harga_menu >= 1000000 && total_harga_menu <= 1250000) {
			...
			cout << "Total pembayaran setelah diskon\t: "<<setelahdiskon<< " Rupiah" << endl;
